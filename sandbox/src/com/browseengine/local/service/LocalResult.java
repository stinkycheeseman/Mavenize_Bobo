...
/**
 * Encapsulates some statistics about the results of a 
 * local search.
 * immutable.
 * 
 * @author spackle
...
public class LocalResult implements Serializable {
	...
	private int numHits;
	private Locatable centroid;

	public LocalResult(LocalRequest request, int numHits, Locatable center) {
		this.request = request;
		this.numHits = numHits;
		this.centroid = center;
	}
	
	public LocalRequest getRequest() {
		return request;
	}
