...
public interface GeoCode {
	Address parseAddress(String addressStr) throws TigerParseException;
	LocatedAddress lookupAddress(Address address) throws IOException, GeoCodingException;
	void close() throws GeoCodingException;
}
